...
exports.UpdateUserTasksEntity1761484052180 = void 0;
class UpdateUserTasksEntity1761484052180 {
    constructor() {
        this.name = 'UpdateUserTasksEntity1761484052180';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "balance_logs" DROP CONSTRAINT "balance_logs_user_id_fkey"`);
        ...
        await queryRunner.query(`ALTER TABLE "user_tasks" DROP CONSTRAINT "user_tasks_user_id_task_id_key"`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD "reward" numeric(10,2)`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD "created_at" TIMESTAMP NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD "started_at" TIMESTAMP`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD "submitted_at" TIMESTAMP`);
        ...
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "reward_received" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "status" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "status" SET DEFAULT 'pending'`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "completed_at" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "users_count" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "total_balance" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "total_earned" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "active_users_24h" SET NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "taken_at" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "settings_history" ALTER COLUMN "created_at" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "balance_logs" ADD CONSTRAINT "FK_16cddcf151cdeeb3d28285ef09e" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD CONSTRAINT "FK_da349034af45568bdc0ab493140" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "balance_logs" DROP CONSTRAINT "FK_16cddcf151cdeeb3d28285ef09e"`);
        ...
        await queryRunner.query(`ALTER TABLE "settings_history" ALTER COLUMN "created_at" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "taken_at" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "active_users_24h" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "total_earned" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "total_balance" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "real_stats_snapshots" ALTER COLUMN "users_count" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "completed_at" SET DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "status" SET DEFAULT 'completed'`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "status" DROP NOT NULL`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ALTER COLUMN "reward_received" SET NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "user_tasks" DROP COLUMN "submitted_at"`);
        await queryRunner.query(`ALTER TABLE "user_tasks" DROP COLUMN "started_at"`);
        await queryRunner.query(`ALTER TABLE "user_tasks" DROP COLUMN "created_at"`);
        await queryRunner.query(`ALTER TABLE "user_tasks" DROP COLUMN "reward"`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD CONSTRAINT "user_tasks_user_id_task_id_key" UNIQUE ("user_id", "task_id")`);
        await queryRunner.query(`CREATE INDEX "idx_settings_history_created_at" ON "settings_history" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "idx_settings_history_admin" ON "settings_history" ("admin_tg_id") `);
        await queryRunner.query(`CREATE INDEX "idx_settings_history_key" ON "settings_history" ("setting_key") `);
        ...
        await queryRunner.query(`CREATE INDEX "idx_real_stats_taken_at" ON "real_stats_snapshots" ("taken_at") `);
        await queryRunner.query(`CREATE INDEX "idx_fake_stats_calculated_at" ON "fake_stats" ("calculated_at") `);
        ...
        await queryRunner.query(`CREATE INDEX "idx_balance_logs_created_at" ON "balance_logs" ("created_at") `);
        await queryRunner.query(`CREATE INDEX "idx_balance_logs_user_id" ON "balance_logs" ("user_id") `);
        ...
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD CONSTRAINT "user_tasks_task_id_fkey" FOREIGN KEY ("task_id") REFERENCES "tasks"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_tasks" ADD CONSTRAINT "user_tasks_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "balance_logs" ADD CONSTRAINT "balance_logs_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "payouts" ADD CONSTRAINT "payouts_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "messages_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
}
exports.UpdateUserTasksEntity1761484052180 = UpdateUserTasksEntity1761484052180;
//# sourceMappingURL=1761484052180-UpdateUserTasksEntity.js.map